...
namespace Prelims.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            FntEntities db = new FntEntities();
            model.Password = SimpleCrypt(model.Password);

            var user = db.USERINFOes.FirstOrDefault(x => x.USERNAME == model.Email && x.PASSWORD == model.Password);
